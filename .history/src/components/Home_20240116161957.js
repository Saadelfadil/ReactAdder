...
const Home = () => {
  ...
  return (
    <div className="flex flex-col gap-10 w-[500px]">
      <button
        className="bg-orange-500500 cursor-pointer text-white uppercase rounded-md px-5 py-2"
        onClick={addRow}
      >
        Add row
      </button>
      ...
      {rows.length === 0 && (
        <>
          <p className="text-center text-2xl uppercase font-light">No rows added yet</p>
