    ...
    <div className="flex flex-col gap-10">
      ...
      {rows.map((row, index) => (
        ...
        >
          ...
          >
            <option className="p-2" value="+">+</option>
            <option className="p-2" value="-">-</option>
          </select>
          <input
            className="bg-gray-300 p-2"
      ...
      <div className="w-full flex bg-blue-500 p-2 rounded-md text-white uppercase justify-center items-center">Result : {resultCalcu()}</div>
    </div>
  );
};
