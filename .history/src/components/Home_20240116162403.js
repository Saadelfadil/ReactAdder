...
const Home = () => {
  ...
  return (
    <div className="flex flex-col gap-10 w-[500px]">
      ...
      {rows.length === 0 && (
        <>
          <p className="text-center text-2xl uppercase font-light">
            No rows added yet
          </p>
          <h1 class="mb-4 text-1xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-1xl dark:text-white">
